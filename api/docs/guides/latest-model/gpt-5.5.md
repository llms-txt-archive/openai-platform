...
- **Agents API:** For new agent applications, start with the [Agents API](https://developers.openai.com/api/docs/guides/agents-api/quickstart) for a managed Codex harness. Use the [Agents overview](https://developers.openai.com/api/docs/guides/agents) to choose a different level of runtime control when needed.
