...
- You can set [spend limits](https://developers.openai.com/api/docs/guides/spend-limits) for the total amount an organization or project can spend on the API each month.
