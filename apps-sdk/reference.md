...
| `_meta["openai/visibility"]`              | Tool descriptor | string       | `public` (default) or `private` | Deprecated OpenAI-specific compatibility field. For new apps, use `_meta.ui.visibility`.                                      |
